...
public class Assignment8 {
    ...
    private List<Integer> cumulativeNumbers = new ArrayList<>(1000);
    ...
    public Assignment8() {
        try {
    		...
    		String workingDir = System.getProperty("user.dir")+"/data/output.txt";	
            numbers = Files.readAllLines(Paths.get(workingDir))
                    .stream()
    ...
    public List<Integer> addItems(List<Integer> numbersParsed){
        synchronized (cumulativeNumbers) {
        	cumulativeNumbers.addAll(numbersParsed);
        	//System.out.println(cumulativeNumbers);
        }
